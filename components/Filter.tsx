  ...
  return (
    <div className="w-full p-5 bg-white">
      <div className="relative">
        ...
        <input type="text" placeholder="Search Product ..." className="px-8 py-3 w-full rounded-md bg-gray-100 border-transparent focus:border-gray-500 focus:bg-white focus:ring-0 text-sm" />
      </div>
